...
router.post("/send-task-notification", async (req, res) => {
  ...
  const mailOptions = {
    from: {
      name: "WorkSync",
      address: "dinildulnethl@gmail.com" //address: employeeEmail || "dinildulnethl@gmail.com"
    },
...
router.post("/send-task-completed-notification", async (req, res) => {
  ...
  const mailOptions = {
    from: {
      name: "WorkSync",
      address: "dinildulnethl@gmail.com" //address: managerEmail || "dinildulnethl@gmail.com"
    },
    to: "dinildulneth123@gmail.com",
