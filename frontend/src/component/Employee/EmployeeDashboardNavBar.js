...
export default function EmployeeDashboardNavBar() {
      ...
      <div className={`sidebar ${isSidebarCollapsed ? 'collapsed' : ''}`}>
        <div className="p-3">
          ...
          <div className="nav flex-column">
            <Link to="/employee" className="nav-link d-flex align-items-center text-secondary mb-2">
              <FaHome className="me-2" /> Dashboard
            </Link>
            <Link to="/employee/leaves" className="nav-link d-flex align-items-center text-secondary mb-2">
              <FaCalendarAlt className="me-2" /> Leave Management
            </Link>
            <Link to="/manager/leaves" className="nav-link d-flex align-items-center text-secondary mb-2">
